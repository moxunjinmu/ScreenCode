...
import { Bot, Code2, Moon, Settings as SettingsIcon, Sun, Video } from 'lucide-react';
...
const COMPACT_TABS: Array<{ id: WorkspaceView; label: string; icon: React.ReactNode }> = [
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const { activeWorkspaceView, setWorkspaceView } = useUIStore();
    ...
    <div className="app-shell">
      <header className="topbar select-none">
        ...
        <div className="topbar-actions">
          <div className={`global-state ${captureState.className}`} aria-live="polite">
          ...
          >
            ...
            <span className="topbar-button-label">{theme === 'dark' ? '暗色' : '亮色'}</span>
          </button>
          <button
            type="button"
      ...
      <nav className="compact-navigation" role="tablist" aria-label="紧凑模式工作区">
