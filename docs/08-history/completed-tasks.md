...
| 任务 | 完成时间 | 关键文件 |
|------|----------|----------|
| 区域截图二次编辑（拖拽移动/resize/确认流程） | 04-17 | RegionCaptureOverlay.tsx |
| 区域截图确认/取消按钮（✓/✕） | 04-17 | RegionCaptureOverlay.tsx |

## 2026-04-16

| 任务 | 完成时间 | 关键文件 |
|------|----------|----------|
| 截图自动保存到系统剪贴板 | 04-16 | Preview/index.tsx, RegionCaptureOverlay.tsx, main/index.ts |
