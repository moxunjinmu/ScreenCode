...
### 0.4 Neo Utility 亮色主题候选（2026-08-03）

![Neo Utility 暖纸白与酸性青柠亮色设计稿](assets/neo-utility-light-ui-concept-v2.png)

亮色稿与 0.3 暗色稿共用布局、信息层级和语义色：应用表面采用暖纸白与雾灰，
正文使用墨色，酸性青柠仍只承担主操作与选中状态，柔紫仅用于 AI 状态。
该图用于双主题方向确认，尚未替换第 3、4 章的正式 Token。界面不常驻展示产品说明、
